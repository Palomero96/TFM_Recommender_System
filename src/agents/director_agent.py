...
class DirectorAgent:
    def __init__(self):
        ...
        self.prompt = PromptTemplate.from_template("""
            Eres un agente director experto en clasificar consultas sobre recomendaciones de libros y peliculas. 
            El usuario te pedirá recomendaciones en base a libros y generos
